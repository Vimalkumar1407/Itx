...
function showSelected() {
            ...
            let resultDiv = document.getElementById('selectedOptions');
            if (selectedOptions.length > 0) {
                resultDiv.innerHTML = `<p class="selected">Selected Options: ${selectedOptions.join(', ')}</p>`;
            } else {
                resultDiv.innerHTML = `<p class="selected">No options selected.</p>`;
            }
        }
